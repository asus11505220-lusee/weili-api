...
def generate_zone1_hedging_matrix(single_freq, pair_stats, triplet_stats, p5, p10, p15, p20, bonds_539, mc_runs=30, history_wl=None):
    ...
    recent_pair_mat = [[0.0]*40 for _ in range(3000)]
    if history_wl:
        # 近30期衰減（50%）
...
def main():
    ...
    if mode == '1':
        ...
        zone1_combos = generate_zone1_hedging_matrix(single_freq, pair_stats, triplet_stats, p5, p10, p15, p20, bonds_539, mc_runs=30, history_wl=work_wl)
...
def get_prediction(zodiac_id: int):
    try:
        ...
        zone1_combos = generate_zone1_hedging_matrix(single_freq, pair_stats, triplet_stats, p5, p10, p15, p20, bonds_539, mc_runs=30, history_wl=history_wl)
